...
//================================================SEND AN EMAIL======
    ...
    // public function reportBug($exception, $data=[])
    // {                                                                       
    //     //ENVIA O EMAIL PARA UM NOVO CLIENTE NO SENTIDO DE CINFIRMAR O EMAIL
    ...
    //         //Recipients
    //         $mail->setFrom(EMAIL_FROM, APP_NAME);
    //         $mail->addAddress("donthimas54@gmail.com");     //Add a recipient
    ...
    //         //ASSUNTO
    //         $mail->isHTML(true);                                  //Set email format to HTML
    //         $mail->Subject = APP_NAME . '-' . 'Error Report';

    //         //MESSAGEM
    //         $html="Ocorreu um erro no sistema detalhes do erro: '<br/>'
    //             Detalhes: '<br/>' ".implode($data)." '<br/>' '<hr/>' '<br/>' 
    //             Causa: '<br/>' $exception";
